...
A lightweight, scalable platform for collecting spoken or written open-text research responses and storing them for downstream processing.
...
The current deployment uses **in-memory storage** because:
